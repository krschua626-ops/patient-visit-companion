...
A clickable demo of a grounded, patient-facing AI assistant for clinical trial visits. Designed to make the concept tangible to product leadership and design partners — not a production system.
...
- **Patient app** (mobile-shaped): home screen with the next-visit card, full visit briefing with an interactive prep checklist, and a grounded chat with a floating action button.
