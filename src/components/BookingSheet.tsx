    ...
    >
      ...
      >
        <SheetBody
          ...
          withCaregiver={withCaregiver}
          setWithCaregiver={setWithCaregiver}
...
function SheetBody({
  ...
  isOutbound: boolean
  tx: PatientVisitContext['transportation']
  context: PatientVisitContext
  defaultPickup: string
  pickupAddress: string
  dropoffAddress: string
  vehicle: Ride['vehicle_preference']
  setVehicle: (v: Ride['vehicle_preference']) => void
  withCaregiver: boolean
  setWithCaregiver: (v: boolean) => void
  wheelchair: boolean
